        ...
        <AnimatePresence>
          {mobileMenuOpen ? (
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-5 light:border-black/10">
                <Link
                  to="/"
              ...
              <div className="border-t border-white/10 pt-6 light:border-black/10">
                {user ? (
                  <Link
                    to="/dashboard"
                    onClick={() => setMobileMenuOpen(false)}
